...
func (controller *Message) MarkAsRead(c fiber.Ctx) error {
	...
	response, err := controller.Service.MarkAsRead(
		whatsapp.ContextWithDevice(c.Context(), getDeviceFromCtx(c)), request)
	utils.PanicIfNeeded(err)
...
func (controller *Message) MarkAsReadBulk(c fiber.Ctx) error {
	...
	response, err := controller.Service.MarkAsReadBulk(whatsapp.ContextWithDevice(c.Context(), getDeviceFromCtx(c)), request)
	utils.PanicIfNeeded(err)
...
func (controller *Message) DeleteMedia(c fiber.Ctx) error {
	...
	err = controller.Service.DeleteMedia(c.Context(), request)
	utils.PanicIfNeeded(err)
